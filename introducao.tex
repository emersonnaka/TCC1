\chapter{Introdução}
	...
	da avaliação. Como há uma grande quantidade de submissões em cursos
...
%	características extraídas pode ter sido primordial para formar os agrupamentos.
	...
	% TODO: Avaliar a visualização ao invéis de avaliar as submissões
	...
	\begin{itemize}
		...
		\item Seleção de uma técnica de projeção adequada para o mapeamento dos \foreign{clusters};
	...
	% TODO: Quais características extraídas
	...
	% TODO: técnicas de mineração
	Com o auxílio dessas ferramentas, foram investigadas as características e técnicas
	...
	% TODO: reescrever este parágrafo para mostrar os resultados do trabalho. Esse TODO passou em branco
...
%	relevantes para todos os usuários.
	...
	aumentar a frequência de utilização da ferramenta \foreign{ScienceView}. Possibilitando
