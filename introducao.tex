\chapter{Introdução}
	...
	o ambiente integrado de desenvolvimento (\ac{IDE}) e ensinam o funcionamento da linguagem sintaticamente.
	...
	in action}) e o desenvolvimento baseado em teste (\ac{TDD}) \cite{camara_graciottoSilva2016}. Na primeira abordagem, a
...
%	características extraídas pode ter sido primordial para formar os agrupamentos.
	...
	\cref{sec:Mooc} apresenta algumas definições de \acs{MOOC} e suas características; a
