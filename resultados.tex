...
\label{chap:resultados}
	...
	A \foreign{Science View} (\ref{sec:scienceView}) utiliza a preservação da vizinhança
	...
	Na \ref{fig:neighborhoodAPOO30} é possível observar que quanto menor a quantidade de
