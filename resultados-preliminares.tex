...
%		"Tokenize the file, run physical line checks and yield tokens."}
	...
	arquivos e cadeia de caractéres. O terceiro exercício consiste na criação das classes
	\texttt{Palavra} e \texttt{Texto}, no qual a primeira classe deve ser utilizada na segunda
	classe, e uma classe para gerar orações gramáticais. O quarto exercício refere-se a
