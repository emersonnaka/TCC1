...
\label{chap:Result}
	...
	deste estudo conforme a \cref{fig:fluxogramaProposta}. % TODO: mencionar que este capítulo é uma instância do método apresentado no capítulo anterior, considerando as fases XYZ. Explique em uma linha o que foi feito para cada fase.
	...
	\section{Extração de características}
		...
		Extraímos da análise estática somente a quantidade de linhas do código-fonte e a % TODO: esta frase ficou estranha, dado que estilo de escrita está dentro de análise estática. 
