...
%		ferramenta é voltada para aqueles que realizarão a correção das submissões.
		...
		O primeiro painel apresenta o número de agrupamentos, representado pelas pilhas,
		...
		por uma determinada palavra no quadro superior, e as pilhas remanescentes no
		...
		A comparação dos conjuntos de programas menores com a pilha maior ocorre entre
		...
		\begin{figure}[h]
			...
			{Representação do tamanho dos agrupamentos (pilhas) para cada problema
				\cite{Glassman:2015}}
