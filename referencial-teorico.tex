...
\label{chap:Ref}
	...
	\label{sec:Mooc}
		...
		Os principais recursos das plataformas utilizados para MOOC são a integração
	...
	\label{sec:FundTeor}
		...
		pelo usuário. Observe que esse sistema pode se realimentar. % TODO: faltou completar algo aqui... se realimentar de que e onde?
		...
		O K-means \cite{macqueen1967} e o \foreign{Density-based Algorithm for Discovering Clusters}
		(DBSCAN) \cite{Ester1996} são exemplos de algoritmos de agrupamento.
...
>>>>>>> d80c3a12312ba77213ace652eb951e0fce85b640
	\label{sec:TrabRel}
		...
		\cite{macqueen1967}. Quando o valor de AMI é 0 (zero), quer dizer que os agrupamentos
		são independentes, entretanto, se for igual a 1, indica perfeita concordância
...
%					valores constantes, etc.
					...
					& K-means
					& Utilizando a métrica AMI, compara os agrupamento automatizados com
