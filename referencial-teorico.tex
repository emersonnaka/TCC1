...
\label{chap:Ref}
	...
	\label{sec:Mooc}
		...
		\citeonline{fassbinder2014} observa que não há uma definição comum na
		...
		currículo. E \citeonline{siemens2013} defende a tendência em inovação e
	...
	\label{sec:FundTeor}
		...
		diversas abordagens, como árvore de decisão, redes neurais e \foreign{support
		...
		\foreign{Density-based Algorithm for Discovering Clusters} \cite{Ester1996} são
