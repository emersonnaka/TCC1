...
\label{chap:Ref}
	...
	\label{sec:FundTeor}
		...
		\label{subsec:dissimilaridade}
			...
			dissimilaridades produz um grupo maior de medidas, já que pode conter qualquer
			...
			dimensionalidade dos dados e esparsos, essa aspecto torna-se desejável pelo
			...
			específica ou do vetor de características, apesar de ter escrito:
		...
		\label{sebsec:qualidade}
			...
			afirma que é difícil qualificar a vizinhança após a utilização de uma técnica
			...
			\subsubsection{Pontuação silhueta}
				...
				\citeonline{rousseeuw1987silhouettes,Tan:2005:ch8} definem
				...
				médias do segundo passo com o primeiro passo, divido pela maior distância média
			...
			\subsubsection{Preservação de vizinhança}
				...
				se a proporção de vizinhança é preservada (\foreign{preservation}).
				
				O resultado do cálculo da preservação de vizinhança pode variar entre $0$ e $1$.
				Quanto mais a vizinhança do objeto multidimensional se assemelha a vizinhança
				do mesmo objeto aplicado as técnicas de projeção, seu resultado tenderá a $1$,
