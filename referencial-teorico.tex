...
\label{chap:Ref}
	...
	\label{sec:FundTeor}
		...
		\label{sebsec:qualidade}
			...
			O parágrafo abaixo é necessário? Tudo bem que eu não escrevi ele bem, por enquanto.
			Mas não vai fazer diferença se eu tirá-lo. Eu acho.
			...
			\subsubsection{Preservação de vizinhança}
				...
				Quanto mais a vizinhança do objeto mutidimensional se assemelha a vizinhança
