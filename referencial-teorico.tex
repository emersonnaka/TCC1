\chapter{Referencial Teórico}
	...
	\section{Fundamentação Teórica}
		...
		Árvore de Decisão, redes neurais e \foreign{support vector machine}, por exemplo.
	...
	\section{Qual título por aqui?}
	    ...
	    \begin{figure}[ht]
	        ...
	        \caption{Visualização t-SNE. Identificação de quatro grupos: roxo, verde,
	        	...
	        	dos códigos. Todas as implementações possuem a função \foreign{combine\_anagrams}
	    ...
	    ferramenta para visualização de informação no qual demonstra os \foreign{clusters} formados,
	    ...
	    \foreign{trace}, elas são consideradas variáveis idênticas.
	    ...
	    erros e fornecer um \foreign{feedback} mais relevante, devido a clusterização
		...
		\begin{figure}
			...
			\caption{Distribuição do agrupamentos. A barra azul representa o agrupamento
				...
				\foreign{cluster size} é referente ao tamanho dos pedaços e os
				\foreign{clusters} representa o número de agrupamentos.}
