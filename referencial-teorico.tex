...
\label{chap:Ref}
	...
	\label{sec:Mooc}
		...
		Os principais recursos das plataformas utilizados para MOOC são a integração com outras
	...
	\label{sec:FundTeor}
		...
		pelo usuário. % TODO: faltou acrescentar que o sistema pode se realiamentar (Aretha)
	...
	\label{sec:TrabRel}
		...
		condição para um segmento do código-fonte. Contudo, esse não é um tópico  % TODO: aqui você esqueceu de mencionar que o trabalho trata do fornecimento de dicas. Daí a frase "Contudo..." perdeu o sentido (e por isso veio a crítica da banca).
		...
		Em \citeonline{Taherkhani:2012}, desenvolveu-se uma ferramenta para classificar  % TODO: informar o nome da ferramenta aqui "ferramenta, denominada Aari, para classificar"
...
%		outras características.
		...
		vetor de características. O Aari, ferramenta de avaliação automática, utiliza  % TODO: s/O Aari/A ferramenta do estudo utiliza a técnica de árvore...
