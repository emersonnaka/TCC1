...
\label{chap:Conclusao}
	...
	Sua utilização ocorreu por meio da \foreign{ScienceView}. E tomaremos como base
	...
	Para responder a \textbf{QP$_2$} foi necessário aplicar o experimento (\cref{sec:avalQualitativa})
