...
\title{Desenvolvimento de Subsídios para Avaliação de Programas em MOOC's com Emprego de Técnicas de Visualização} % Título do trabalho
...
a necessidade de fornecer \foreign{feedbacks} para cada aluno que solucionou o problema.
Para agravar essa dificuldade, cursos massivos, abertos e \foreign{online} (MOOC) possuem
...
correções manualmente. E verificaremos se o \foreign{feedback} está sendo construtivo
ao aluno conforme seu \foreign{feedback} e da qualidade das próximas implementações.
...
as correções possam ser realizadas minuciosamente de modo a realizar um \foreign{feedback}
