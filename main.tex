...
\title{Desenvolvimento de Subsídios para Avalização de Programas em MOOC's com Emprego de Técnicas de Visualização} % Título do trabalho
\titleen{} % Título traduzido para inglês
\advisor{Profº. Dr. Marco Aurélio Graciotto Silva} % Nome do orientador. Lembre-se de prefixar com "Prof. Dr.", "Profª. Drª.", "Prof. Me." ou "Profª. Me."}
