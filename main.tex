...
\title{Avaliação de atividades de programação submetidas em MOOC com emprego de técnicas de visualização} % Título do trabalho
\titleen{Assessment of programming activities submitted in MOOC using visualization techniques} % Título traduzido para inglês
