...
um \foreign{feedback} para o aluno com relação a sua implementação. Para agravar essa
...
\textbf{Objetivo:} O objetivo deste trabalho é propor subsídios para a avaliação de  % TODO: imediatamene após a frase de objetivos, estabelecer os subsídios correspondem a ferramentas, medidas e diretivas para o emprego de técnicas de visualização, com o auxílio da ferramenta.
