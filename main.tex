...
verificando o \foreign{feedback} da ferramenta para o professor.
...
programs. To test the tool, we have two different source database.

The validation will occur in two steps: through the quality of the visualizations
