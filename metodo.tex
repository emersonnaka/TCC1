...
%		"Tokenize the file, run physical line checks and yield tokens."}
			...
			A ferramenta \texttt{mccabe} \cite{mccabeabebe2013} fornece informações sobre a
	...
	\section{Ferramentas}
		...
		\label{sec:scienceView-Python}
			...
			é genérico o suficiente para este propósito e também facilita sua edição em \foreign{softwares}
