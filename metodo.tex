...
%		"Tokenize the file, run physical line checks and yield tokens."}
	...
	\section{Ferramentas}
		...
		\label{sec:scienceView-Python}
			...
			cada código-fonte a fim de ser utilizada na \foreign{ScienceView} \ref{sec:scienceView}.
		...
		normalização disponíveis. Após selecionar, clique em \foreign{Next} para continuar.
