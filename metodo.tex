...
\label{chap:metodos-ferramentas}
	...
	Neste capítulo será apresentado o método utilizado, os resultados obtidos durante   % TODO: atualizar este parágrafo para refletir o novo conteúdo deste capítulo
	...
	foram feitas usando a ferramenta \foreign{Science View}.
 	...
 	\section{Método}
	 	...
	 	\foreign{feedback} da \foreign{Science View} (\cref{sec:scienceView}) para o professor.
...
%		"Tokenize the file, run physical line checks and yield tokens."}
		...
		\subsection{Projeção e visualização}
			...
			ferramenta \foreign{Science View} \cite{Alencar-etal:2012} que utiliza a
	...
	\section{Ferramentas}
		...
		\label{sec:scienceView-Python}
			...
			cada código-fonte a fim de ser utilizada na \foreign{Science View} (\cref{sec:scienceView}).
			...
			\foreign{ScienceView-Python} e como arquivo de entrada da \foreign{Science View}.
			...
			e leitura do arquivo. Além de possibilitar a adaptação da \foreign{Science View}
		...
		A ferramenta \foreign{Science View} \cite{Alencar} foi desenvolvida para criar
		...
		forma é possível visualizar os agrupamentos encontrados pela \foreign{Science View},
		...
		de gerar os grupos para cada projeção na sequência, a \foreign{Science View}
