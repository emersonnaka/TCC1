...
\textbf{Conclusions:} We conclude that, the bigger theamount of data to be observed,
lower the quality loss of the projection in order to answer the \textbf{QP$_1$}.
And limited use of ScienceView tool may have been one of the reasons why we didn't
prove \textbf{QP$_2$}. Finally, we identify forthcoming work this study in order to
...
motivos para que não comprovássemos a \textbf{QP$_2$}. Por fim, identificamos os
trabalhos futuros desse estudo a fim de torná-lo mais relevante.
